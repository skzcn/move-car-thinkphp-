...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='挪车记录表';

-- ----------------------------
-- Records of move_car_logs
-- ----------------------------
INSERT INTO `move_car_logs` VALUES ('1', '2', '', 'null', 'null', 'confirmed', '1768664940', '1768664940');
...
INSERT INTO `system_config` VALUES ('7', 'site_keywords', 'test', 'basic', '网站关键词');
INSERT INTO `system_config` VALUES ('8', 'site_description', 'test', 'basic', '网站描述');
INSERT INTO `system_config` VALUES ('9', 'site_contact', 'test', 'basic', '联系方式');
INSERT INTO `system_config` VALUES ('10', 'site_icp', '123456789', 'basic', 'ICP备案号');
INSERT INTO `system_config` VALUES ('11', 'wxpush_app_token', 'TEST_TOKEN_1768666258', 'basic', 'WxPush AppToken');
...
CREATE TABLE `users` (
  ...
  `create_time` int(11) DEFAULT NULL COMMENT '创建时间',
  `update_time` int(11) DEFAULT NULL COMMENT '更新时间',
  `webhook_url` varchar(255) DEFAULT '' COMMENT 'Webhook地址',
  `qywx_key` varchar(255) DEFAULT '' COMMENT '企业微信Key',
  `dingtalk_token` varchar(255) DEFAULT '' COMMENT '钉钉Token',
  `wxpush_uid` varchar(255) DEFAULT '' COMMENT 'WxPush UID',
  `wxpush_app_token` varchar(255) DEFAULT NULL,
  `tg_bot_token` varchar(255) DEFAULT '' COMMENT 'Telegram Bot Token',
  `tg_chat_id` varchar(255) DEFAULT '' COMMENT 'Telegram Chat ID',
  `notify_type` varchar(50) DEFAULT 'bark' COMMENT '当前使用的通知方式',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_username` (`username`) USING BTREE
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', '1', null, '1', '11', '', null, '', 'SCT130806T7ozf9WqlpzvuJ0fAnmv0Uzr3', '1', '1768400766', '1768401170', '', '', '', '', null, '', '', 'bark');
INSERT INTO `users` VALUES ('2', '123', '$2y$12$wGElyjOl/iyDbbQLtumoZe0QnYSxvy1Facu8RA7omVElc.lzzofGK', '', '', '', '', '', '', '1', '1768402880', '1768706086', '', '', '', '', '', '', '', 'email');
